...
| CAL-PLATT-UPGRADE ready — O/U | Settled O/U bets (won+lost, 2.5 only, all versions) | 300+ | **73** (over: 20, under: 53) — 2026-05-12 audit | ~4-6 weeks. 353 count in previous audit was predictions table rows, not placed bets. |
| CAL-PLATT-UPGRADE ready — 1X2 | Settled 1X2 bets (won+lost, model_version=v14) | 300+ | **114 per outcome** | ~2-3 weeks |
