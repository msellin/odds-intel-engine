...
| BOT-1X2-AWAY-LOSERS | P2 | 2-3h | **Structural finding from PER-BOT-SLICE-TIGHTEN:** "away" 1X2 bets lose -14 to -21% ROI across bot_aggressive (902 bets, -€1331), bot_v10_all (471 bets, -€977), bot_aggressive_v2 (304 bets, -€631). "home" 1X2 also drags (bot_v10_all -19% ROI, 172 bets, -€328). Pattern is consistent across all three. Investigate: (1) Is this a calibration artifact of the Poisson backfill model (overestimates away-win prob)? (2) Does the live filter stack (Pinnacle veto + sharp_consensus) correct this? (3) If pattern persists in live data, consider dropping 1X2 home/away from broad bots and keeping only goal-line markets (OU/BTTS) where edge is cleaner. Do NOT act until we have 50+ live settled 1X2 bets per selection type post-retirement of bot_aggressive. |
