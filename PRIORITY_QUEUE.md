...
> Last updated: 2026-05-07 — H2H-SPLITS done (h2h_avg_goal_diff + h2h_recency_premium, migration 067 adds team API IDs to matches — also fixes MGR-CHANGE signal which was silently broken). AH-SIGNALS done earlier today.
