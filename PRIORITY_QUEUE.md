...
| ID | Task | Effort | ☑ | Ready? | Notes |
|----|------|--------|----|--------|-------|
| PIN-2 | Extend Pinnacle signals to all bet markets | 1h | ⬜ | ✅ Ready | Add `pinnacle_implied_draw`, `_away`, `_over25`, `_under25` to `batch_write_morning_signals()` in supabase_client.py. Same bulk query pattern as PIN-1. Unlocks PIN-3, PIN-4. Pinnacle covers 59% of our matches. |
