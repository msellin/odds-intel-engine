...
> Last updated: 2026-05-09 — POOL-FANOUT shipped (cap settlement enrichment to 2 workers, APScheduler executor to 4, bulk events insert via execute_values, lower wait timeout 60→15s) addressing actual root causes of pool saturation.
