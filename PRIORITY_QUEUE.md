...
| PER-BOT-EDGE-THRESHOLD-OPTIMIZE | P2 | 2-3h | After CAL-PLATT-WIDER-INPUT. For each bot, sweep edge thresholds across 3-10% on the expanded backtest pool, find ROI-maximizing threshold per bot, apply via BOTS_CONFIG. Some bots may want higher thresholds (tighter), others lower (looser). Validate live for 2-3 weeks after change. |
