...
| COMBO-RESEARCH-PHASE-D | P3 | 1-2 days | **Cross-match acca bot** — combines 2-3 of the day's highest-edge single bets into a single accumulator. Only viable if Phase A confirms Coolbet does NOT compound combo margin (i.e., 3-leg combo odds = product of leg odds, no extra cut). If margin compounds normally (likely), this is -EV and we skip. Gated on Phase A confirming favourable combo pricing. |
