...
> Last updated: 2026-05-08 — BOT-PUBLIC-PERF: /performance replaces /track-record. 4-tier gated public bot performance page. CLV hero metric. Redirect from /track-record. Also prior: PRUNE-MONITORING + STAKE-RANK + API-RETRY-WRAPPER.
