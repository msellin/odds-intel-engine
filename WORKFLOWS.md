...
05:30/17:30  1X2 Rating Shadow  job_rating_1x2_shadow()  Daily ([[#141]], 2026-09-24). Walk-forward rating pass over every finished match + `rating_history_results`, fits the D8+ logit, writes `rating_1x2_predictions` for fixtures in the next 2 days. SHADOW ONLY — nothing stakes or publishes from it. ~1-2 min. MODEL_WHITEPAPER §4.4.
