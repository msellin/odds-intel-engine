...
*/2 :05  ⑳ CS2 HLTV ups  job_cs2_hltv_upcoming()         Every 2h at :05 — scrape hltv.org/matches, upsert upcoming fixtures + ELO-enrich. CS2-UPCOMING-VETO-SCRAPE 2026-06-30: also fetches individual match pages for HLTV-sourced upcoming matches and writes veto sequences to cs2_hltv_match_veto so v9 veto features activate at prediction time.
