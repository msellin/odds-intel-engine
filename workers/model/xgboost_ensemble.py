...
def get_xgboost_prediction(home_team: str, away_team: str,
    ...
    try:
        ...
        # dev/active/draw-regression-plan.md for the full motivation.
        # Both this live-inference path AND weekly_eval_and_compare use
        # the same helper so rigorous_eval reflects the same numbers the
        # bots see.
        from workers.model.draw_calibration import apply_draw_calibration
        home_prob, draw_prob, away_prob = apply_draw_calibration(
