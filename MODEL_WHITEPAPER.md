...
**Active production version (2026-07-18):** `MODEL_VERSION=v20260712` (main head — governs 1X2 + BTTS + AH via the joint-goal matrix). `MODEL_VERSION_OU=v20260621` and `MODEL_VERSION_OU_T1=v20260621` kept as env overrides because v20260712 regressed on OU 2.5 (+1.8% log-loss) despite being clearly better on the rest of the market surface.
