...
Data tier system:
- **Tier A**: team in targets_poisson_history.csv — Poisson + XGBoost available. European leagues + Romania (RO1, since 2026-05-12); TIER-C-EXPAND (2026-05-19) ships a parameterised ingest script (`scripts/ingest_football_data_extras.py`) for 15 more top divisions — ARG/AUT/BRA/CHE/CHN/DNK/FIN/IRL/JPN/MEX/NOR/POL/RUS/SWE/USA — that need a local run to populate the CSV.
