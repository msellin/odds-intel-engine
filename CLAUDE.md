...
| `src/app/(app)/admin/bots/money-view.tsx` | Real money — the money ledger (`/admin/bots?section=money`; `/admin/real-bets` redirects, #162 W6.8) |
