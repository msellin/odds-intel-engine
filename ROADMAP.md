...
| /admin/bots | ✅ Superadmin unified bot board (#139 phase 1, 2026-09-24): every bot from all three ledgers via `bot_scoreboard` (mig 410), grouped by family, each judged only on its admissible metric; config drawer from `bot_config`; Retired tab |
