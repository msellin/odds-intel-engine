...
- [ ] Add OG image for social sharing (when link is shared on WhatsApp/Twitter)
- [ ] Stripe: create account + products (Pro €19/mo, Elite €49/mo), add keys to Vercel
...
| # | Feature | DB source | Tier | Notes |
|---|---------|-----------|------|-------|
| 6 | Team season stats card | `team_season_stats` | Pro | Goals avg, clean sheet%, home/away split |
