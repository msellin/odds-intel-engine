...
**SCOPE (owner, 2026-09-26): #191 must not break or change any PICKS / /performance / Telegram-facing bot — it covers only
the remaining bots and instruments that make the OWN track.** Verified: all 15 fold/retire candidates are 'experimental',
not on /performance, not sent public, not VIP. Five of them are PICKS-side experiments even though hidden — rows 8, 14,
15, 16, 17 (sharp-aligned + pinconf forward-test twins, consensus grade D, rating/combined 1X2 model research) — and are
**OUT of #191**: left untouched, handed to the PICKS side (#185, Monday). Their verdicts below are information only.
...
| 8 | bot_sharp_aligned_v1 | forward-test twin (fetch-time freshness) | −2.5% (5); gate meaningless per §88 | OUT OF SCOPE (PICKS side → #185); audit said: RETIRE |
...
| 14 | bot_rating_1x2_v1 | superseded rating model | −7.8% (4); ROI −64% | OUT OF SCOPE (PICKS side → #185); audit said: RETIRE |
| 15 | bot_combined_1x2_v1 | NEW+ copy of a /perf bot | — (2) | OUT OF SCOPE (PICKS side → #185); audit said: RETIRE (duplicate) |
| 16 | bot_consensus_d_v1 | consensus grade D, never sent | −1.1% (35) | OUT OF SCOPE (PICKS side → #185); audit said: RETIRE (keep grade D as a data slice) |
| 17 | bot_consensus_pinconf_v1 | consensus twin, gate rejected 0 of 77 | +4.5% (19, all non-Estonian) | OUT OF SCOPE (PICKS side → #185); audit said: RETIRE (comparison reads 0 by construction) |
