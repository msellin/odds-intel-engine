...
- [ ] W4.6 delete retired money code (agent running)
- [ ] W4.2 structural: exposure + final floor inside assert_may_place (after W4.6)
- [ ] W4.7 COOLBET_OWN_BETTING rewrite (after W4.6)
- [ ] W4 close: money_gate_contract 0 → 1 with GATE_CONTRACT = 1 (after W4.2/4.6/4.7)
- [ ] W5.5 Telegram controls audited (agent running)
- [ ] W5.3 one audited sender (agent running)
- [ ] W5.4 + W6.3 arm registry + anchor_clv (agent running)
- [ ] W7.2 dead pipeline code (agent running)
- [ ] W7.4 + W6.8 Bots page speed + Real money folded in (agent running)
