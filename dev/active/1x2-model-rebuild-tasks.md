...
- [x] **B5. Takeability** — ✅ 2026-09-24: pre-registered rule NOT APPLICABLE (cadence 30–60 min); descriptive evidence: quotes persist (median 1.5–6 h, 5–14% single-snapshot); no book excluded. Plan doc B5 RESULT. — for picks like B2's, how often is the above-consensus quote still
