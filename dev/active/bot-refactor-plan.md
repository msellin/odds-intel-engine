...
| W4.3a | ⟲ **Owner 2026-09-25: real-money sizing is FLAT** — `placement_gate` owns ONE flat stake for every executor (today the router already uses a fixed STAKE_EUR; verify the UI placer / API path and remove any Kelly sizing) | §3.5 | Money sizing | with W4.2, 2 reviewers |
