...
- [⬜] **1.6b** Add `job_tennis_settlement` (02:00 + 14:00 UTC) + `job_tennis_closing_odds` (hourly 06-22 UTC)
...
- [⬜] **1.8b** Smoke `TENNIS-SETTLEMENT` + `TENNIS-CLOSING-ODDS` (with their tasks)
